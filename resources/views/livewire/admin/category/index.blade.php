        ...
        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            ...
            <tbody wire:loading.remove wire:target="search">
                ...
                <tr
                    ...
                    <td class="py-4 px-6">
                        <div class="h-20">
                            <img src="{{ asset('/storage/'.$cat->image) }}" class="object-contain w-fit h-full">
                        </div>
                    </td>
                    <td class="py-4 px-6 ">
            ...
            <div class="relative z-0 mb-6 w-full group">
                ...
                <div class="flex items-center justify-center w-full">
                    ...
                    <div class="h-80 overflow-hidden relative">
                        ...
                        <span
                            class="absolute right-4 top-4 px-2 py-[2px] text-white bg-gray-400 rounded-full hover:cursor-pointer"
                    ...
                    <label for="dropzone-file"
                        class="{{ $image ? 'hidden' : 'flex' }} flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
