            ...
            <tbody wire:loading.remove wire:target="search">
                @foreach ($promos as $pro)
                    <tr
                        ...
                        <td class="py-4 px-6" style="letter-spacing: initial">
                            {{ $this->getDetails($pro) }}
                        </td>
                        ...
                        <td class="py-4 px-6 ">
                            <div class="space-x-2 flex flex-nowrap items-center">
                                <a href="{{ route('admin.promo.edit', $pro) }}"
