    <div class="flex flex-wrap items-center justify-between mt-4 mb-8">
        ...
        <div class="flex items-center md:order-2">
            <button type="button"
                class="flex mr-3 text-s rounded-full md:mr-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600"
                id="user-menu-button" aria-expanded="false" data-dropdown-toggle="user-dropdown"
                data-dropdown-placement="bottom">
                <span class="sr-only">Open user menu</span>
                <img class="w-8 h-8 rounded-full" class="object-cover"
                    src="https://ui-avatars.com/api/?name=a&color=7F9CF5&background=EBF4FF" alt="user photo">
            </button>
            <!-- Dropdown menu -->
            ...
            <button type="button"
                ...
                data-drawer-target="drawer-navigation-dashboard" data-drawer-show="drawer-navigation-dashboard"
