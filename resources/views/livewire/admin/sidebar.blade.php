    ...
    <!-- drawer component -->
    <div id="drawer-navigation" class="md:hidden block fixed z-40 h-screen p-4 overflow-y-auto bg-[#0E2238] w-80 dark:bg-gray-800" tabindex="-1" aria-labelledby="drawer-navigation-label">
