                ...
                <ul class="text-gray-600 dark:text-gray-400">
                    <li class="mb-3">
                        <a href="{{ route('products.index') }}"
                            class="hover:underline text-gray-500 hover:text-gray-600 uppercase">Shop All </a>
                    </li>
                    @if ($categories)
                        @foreach ($categories as $cat)
                            <li class="mb-3">
                                <a href="{{ route('products.index', ['cat' => $cat->name]) }}"
                                    class="hover:underline text-gray-500 hover:text-gray-600 uppercase">
                                    {{ $cat->name }}</a>
                            </li>
                        @endforeach
                    @endif
                ...
                <ul class="text-gray-600 dark:text-gray-400">
                    @auth
                        <li class="mb-3">
                            <a href="{{ route('profile.show') }}"
                                class="hover:underline text-gray-500 hover:text-gray-600 capitalize">My account</a>
                        </li>
                    @endauth
                    @guest
                        <li class="mb-3">
                            <a href="{{ route('login') }}"
                                class="hover:underline text-gray-500 hover:text-gray-600 capitalize ">login</a>
                        </li>
                        <li class="mb-3">
                            <a href="{{ route('register') }}"
                                class="hover:underline text-gray-500 hover:text-gray-600 capitalize">Register</a>
                        </li>
                    @endguest
                    ...
                    <li class="mb-3">
                        <a href="{{ route('orders.index') }}"
                            class="hover:underline text-gray-500 hover:text-gray-600 capitalize">your orders</a>
                    </li>
                </ul>
            </div>
            <div class="wow slideInRight">
                ...
                <ul class="text-gray-600 dark:text-gray-400">
                    <li class="mb-4">
                        <a href="{{ route('contact') }}"
                            class="hover:underline text-gray-500 hover:text-gray-600">Contact Us</a>
                    </li>
                </ul>
            </div>
        </div>
