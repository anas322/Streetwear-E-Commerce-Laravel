                ...
                <div class="flex gap-x-4">
                    ...
                    <a href='{{ route('cart') }}'
                        ...
                        @auth
                            @if (auth()->user()->carts->count() > 0)
                                <div
                                    class="absolute inline-flex items-center justify-center text-center w-6 h-6 text-xs font-bold text-white bg-cyan-600 border-2 border-white rounded-full -top-3 -right-3 dark:border-gray-700">
                    ...
                    @guest
                        <a href='{{ route('profile.show') }}'
                            class="hover:text-gray-400 text-gray-900 dark:hover:text-white">
                        ...
                        <x-jet-dropdown align="right" width="60">
                            <x-slot name="trigger">
                                <span class="inline-flex rounded-md">
                                    <button type="button"
                                        class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-thin rounded-md text-black hover:bg-gray-50 hover:text-gray-700 focus:outline-none focus:bg-gray-50 active:bg-gray-50 transition">
                        ...
                        <x-jet-dropdown align="right" width="48">
                            <x-slot name="trigger">
                                ...
                                @else
                                    <span class="inline-flex rounded-md">
                                        <button type="button"
                                            class="inline-flex items-center px-3 py-2 border border-transparent text-lg leading-4 font-medium rounded-md text-gray-500 bg-transparent hover:text-gray-700 focus:outline-none transition">
                                            {{ Auth::user()->name }}
