<nav x-data="{ open: false }" id="navbar" class="bg-white z-40 w-full fixed top-0">
        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                ...
                <div class="flex gap-x-4">
                    ...
                    <a href='{{ route('cart') }}'  class="relative hover:text-gray-400 text-gray-900 dark:hover:text-white" >
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 10.5V6a3.75 3.75 0 10-7.5 0v4.5m11.356-1.993l1.263 12c.07.665-.45 1.243-1.119 1.243H4.25a1.125 1.125 0 01-1.12-1.243l1.264-12A1.125 1.125 0 015.513 7.5h12.974c.576 0 1.059.435 1.119 1.007zM8.625 10.5a.375.375 0 11-.75 0 .375.375 0 01.75 0zm7.5 0a.375.375 0 11-.75 0 .375.375 0 01.75 0z" />
                        </svg>
                        @auth
                        @if (auth()->user()->carts->count() > 0)
                        <div class="absolute inline-flex items-center justify-center text-center w-6 h-6 text-xs font-bold text-white bg-cyan-600 border-2 border-white rounded-full -top-3 -right-3 dark:border-gray-700">{{ auth()->user()->carts->count() }}</div>  
                        @endif
                        @endauth
                    </a>
                    
                    @guest
                        <a href='{{ route('profile.show') }}' class="hover:text-gray-400 text-gray-900 dark:hover:text-white">
                        ...
                        <x-jet-dropdown align="right" width="60">
                            <x-slot name="trigger">
                                <span class="inline-flex rounded-md">
                                    <button type="button" class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-thin rounded-md text-black hover:bg-gray-50 hover:text-gray-700 focus:outline-none focus:bg-gray-50 active:bg-gray-50 transition">
                    ...
                    <x-jet-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            ...
                            <button class="flex text-sm border-2 border-transparent rounded-full focus:outline-none focus:border-gray-300 transition">
                                ...
                                @else
                                <span class="inline-flex rounded-md">
                                    <button type="button" class="inline-flex items-center px-3 py-2 border border-transparent text-lg leading-4 font-medium rounded-md text-gray-500 bg-transparent hover:text-gray-700 focus:outline-none transition">
                                        {{ Auth::user()->name }}
                ...
                <div>
                    <div class="flex items-center md:order-2">
                        @guest
                            ...
                            <a href="{{ route('register') }}" class="text-white bg-gray-800 hover:bg-gray-900 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 md:px-5 md:py-2.5 mr-1 md:mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Sign up</a>
                        @endguest
